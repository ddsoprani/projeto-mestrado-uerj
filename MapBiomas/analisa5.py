...
# ============================
shp_path = "/home/danilo/Projeto-Mestrado/Testes_Shape_File_INPE/ES_Municipios_2024/ES_Municipios_2024.shp"
...
# ============================
raster_path = "2022_deforestation_annual_1-1-1_74215b40-a389-43b6-aa16-ebdcb7b9a252.tif"
...
for idx, muni in es.iterrows():
    ...
    resultados.append({
        ...
        "pixels_desmat_2022": pixels_desmat,
        "area_desmat_ha_2022": area_ha
    })
...
df.to_csv("desmatamento_ES_2022.csv", index=False)

print(df)
print("\nArquivo salvo como: desmatamento_ES_2022.csv")
