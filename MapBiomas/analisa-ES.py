...
with open(f"/home/danilo/Projeto-Mestrado/Coverage/CSV-ES/_{ano_anterior}_cobertura_por_municipio_ES.csv", newline="", encoding="utf-8-sig") as f:
...
df_municipios.to_csv(
    f"CSV-ES/_{ano}_desmatamento_municipios_ES.csv",
    sep=';',
    decimal=',',
    index=False
);
