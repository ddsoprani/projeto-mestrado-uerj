...
df_final = df_final.sort_values(by=["provincia", "distrito", "mes"])
#print(df_final.head(20));

# 6. Salvar
df_final.to_csv(f"dados-climaticos/{ano}/dados_climaticos_mensais_era5_distritos_Mocambique_{ano}.csv", sep=';', decimal=',', index=False)

print(f"Arquivo salvo com nome: dados-climaticos/{ano}/dados_climaticos_mensais_era5_distritos_Mocambique_{ano}.csv");
